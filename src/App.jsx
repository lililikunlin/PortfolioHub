...
import { 
  ...
  Briefcase, Gamepad2, Rocket, ExternalLink, LogOut
} from 'lucide-react';
    ...
    <div style={{ padding: '40px 20px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <section style={{ marginBottom: '50px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '25px' }}>
          {[
            { id: 'portfolio', title: '個人專案網站', desc: '使用 React + Vite 打造，並結合 Firebase 實作留言板與評分系統的個人技術展示平台。', icon: <Rocket size={20} color="var(--neon-purple)"/> },
            { id: 'water-puzzle', title: 'Water Puzzle', desc: '經典的水桶倒水解謎遊戲，考驗邏輯與演算法實作能力。', icon: <Gamepad2 size={20} color="var(--neon-purple)"/> },
            { id: 'minesweeper', title: 'Minesweeper', desc: '復刻經典踩地雷遊戲，包含遞迴展開空白區域與插旗功能。', icon: <Gamepad2 size={20} color="var(--neon-purple)"/> }
          ].map((item) => (
